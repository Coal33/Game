...
void Title::draw() const {
	...
	FontAsset(U"Title")(titleText).drawAt(center.movedBy(4, 6),
	                                      ColorF(0.0, 0.5));
	...
	FontAsset(U"Menu")(U"はじめる")
	    .drawAt(m_startButton.center(), ColorF(0.25));
	...
	FontAsset(U"Score")(U"High score: {}"_fmt(highScore))
	    .drawAt(Vec2(620, 550));
}
